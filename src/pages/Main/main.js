...
function Main() {
    ...
    const [todayVisitCount, setTodayVisitCount] = useState(0);  // 오늘 접속자 수 카운트
    const [totalVisitCount, setTotalVisitCount] = useState(0);  //누적 접속자 수 카운트
    ...
    return (
        <div className="iphone-frame1">
            <img style={{position: "absolute", marginTop:"-180%"}} src='../../img/swuniforest.png'/>
            ...
            <button className='box1' onClick={() => navigate('/booth')}>
